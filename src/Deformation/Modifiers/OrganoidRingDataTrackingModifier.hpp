#ifndef ORGANOIDRINGDATATRACKINGMODIFIER_HPP_
#define ORGANOIDRINGDATATRACKINGMODIFIER_HPP_
...
class OrganoidRingDataTrackingModifier : public AbstractCellBasedSimulationModifier<DIM>
{

private:

//	c_vector<unsigned, DIM> mCellVolumeParameters;
    ...
    out_stream mpOrganoidRingDataFile;
...
public:
     ...
     */
    OrganoidRingDataTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~OrganoidRingDataTrackingModifier();
    ...
    std::vector<unsigned> CountCellMutationStates(AbstractCellPopulation<DIM>& rCellPopulation);
...
#endif /*ORGANOIDRINGDATATRACKINGMODIFIER_HPP_*/
