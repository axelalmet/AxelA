 ...
 * Anoikis cell killer created for Organoid model. Removes any epithelial cells that have detached from the ring
 * and entered the 'ghost node region'. Adapted from SJD's CrossSectionModelRandomCellKiller
 *
...
#include "OrganoidAnoikisCellKiller.hpp"
...
OrganoidAnoikisCellKiller::OrganoidAnoikisCellKiller(AbstractCellPopulation<2>* pCellPopulation)
...
OrganoidAnoikisCellKiller::~OrganoidAnoikisCellKiller()
{
//    mAnoikisOutputFile->close();
}

//Method to get mCutOffRadius
double OrganoidAnoikisCellKiller::GetCutOffRadius()
{
	return mCutOffRadius;
}

//Method to set mCutOffRadius
void OrganoidAnoikisCellKiller::SetCutOffRadius(double cutOffRadius)
{
	mCutOffRadius = cutOffRadius;
}

std::set<unsigned> OrganoidAnoikisCellKiller::GetNeighbouringNodeIndices(unsigned nodeIndex)
{
 ...
 */
bool OrganoidAnoikisCellKiller::HasCellPoppedUp(unsigned nodeIndex)
{
 ...
 */
std::vector<c_vector<unsigned,2> > OrganoidAnoikisCellKiller::RemoveByAnoikis()
{
 ...
 */
void OrganoidAnoikisCellKiller::CheckAndLabelCellsForApoptosisOrDeath()
{
	if (dynamic_cast<MeshBasedCellPopulation<2>*>(this->mpCellPopulation))
	{
		MeshBasedCellPopulation<2>* p_tissue = static_cast<MeshBasedCellPopulation<2>*> (this->mpCellPopulation);
...
void OrganoidAnoikisCellKiller::SetNumberCellsRemoved(std::vector<c_vector<unsigned,2> > cellsRemoved)
{
...
unsigned OrganoidAnoikisCellKiller::GetNumberCellsRemoved()
{
	return mCellsRemovedByAnoikis;
}

void OrganoidAnoikisCellKiller::SetLocationsOfCellsRemovedByAnoikis(std::vector<c_vector<unsigned,2> > cellsRemoved)
{
	if (dynamic_cast<MeshBasedCellPopulation<2>*>(this->mpCellPopulation))
	{
		MeshBasedCellPopulation<2>* p_tissue = static_cast<MeshBasedCellPopulation<2>*> (this->mpCellPopulation);
...
std::vector<c_vector<double,3> > OrganoidAnoikisCellKiller::GetLocationsOfCellsRemovedByAnoikis()
{
	return mLocationsOfAnoikisCells;
}

void OrganoidAnoikisCellKiller::OutputCellKillerParameters(out_stream& rParamsFile)
{
